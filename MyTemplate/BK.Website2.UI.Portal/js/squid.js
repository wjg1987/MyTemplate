    ...
    Squid.extend({
        ...
        getElementsByClassName: function(className, context) {
            ...
            if(context.getElementsByClassName) {
                elems = context.getElementsByClassName(className);				
                r = slice.call(elems, 0);
            }else{
                var elem,
                    i = 0,
        ...
        getElementsByAttribute: function(attrName, context) {
            var r = [];
            ...
            if(context.querySelectorAll) {
                attrName = '[' + attrName + ']'
                r = context.querySelectorAll(attrName);
            }else{
                var i = 0,
                    length,
                    elem,
                ...
                for(; i < length; i++) {
                    elem = elems[i] 
                    if(elem.nodeType === 1 && elem.getAttribute(attrName) != null) {
                        r.push(elem); 
                    }
                }
            }
