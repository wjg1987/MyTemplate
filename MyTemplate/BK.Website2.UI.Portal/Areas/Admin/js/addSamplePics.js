    ...
    for (var i = 0; i < divs.length; i++) {
        ...
        if (id == file.id) {
            if (jd.Success) {
                ...
                $(divs[i]).append("<a class='delMore_img' data-hiddenName='" + o_parent.attr("id") + "' href='javascript:;' onclick=\"delMore_uploadimg(this,'" + jd["SaveName"] + "','" + o_parent.attr("id") + "')\"><img src='/images/morelist_del.png' /></a>");
