    ...
    function finishStep(wizard, state) {
        ...
        for (var i = 0; i < areaAndstyepics.length; i++) {
            ...
            for (var j = 0; j < lis.length; j++) {
                var areaid = $(lis[j]).find(".btn-deletstyle").data("areaid");
                var styid = $(lis[j]).find(".btn-deletstyle").data("styid");

                areaStylePriceAndPics.styleandpics[index] = { 'areaid': areaid, 'styleid': styid};
                index++;
            }
        }
