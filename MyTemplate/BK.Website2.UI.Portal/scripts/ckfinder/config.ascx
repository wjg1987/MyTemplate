...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
        ...
        return Session["curLoginAdminID"] != null;
	}
	...
	public override void SetConfig()
	{
		...
		// feature.
		Images.MaxWidth = 4600;
		Images.MaxHeight = 4200;
		Images.Quality = 80;
		...
		type.MaxSize = 0;
		type.AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv",  "gz", "gzip",  "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip","ogv","webm" ,"f4v"};
		type.DeniedExtensions = new string[] { };

		type = ResourceType.Add( "Images" );
		type.Url = BaseUrl + "/images/";
		type.Dir = BaseDir == "" ? "" : BaseDir + "/images/";
        type.MaxSize = 1024*1024*1;
